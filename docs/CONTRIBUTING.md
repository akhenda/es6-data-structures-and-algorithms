# Contributing to ES6 Data Structures and Algorithms

First and foremost, thank you! We appreciate that you want to contribute to ES6 Data Structures and Algorithms, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for ES6 Data Structures and Algorithms**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for ES6 Data Structures and Algorithms:

- star the [project](https://github.com/akhenda/es6-data-structures-and-algorithms)
- tweet your support for ES6 Data Structures and Algorithms
...
- **version**: (required) please note the version of ES6 Data Structures and Algorithms are you using
...
The original poster or the maintainers of ES6 Data Structures and Algorithms may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/es6-data-structures-and-algorithms
